...
GO
PRINT N'Идет создание Таблица [dbo].[Doctors]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[Patients]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[RegistrationСards]…';
...
GO
ALTER TABLE [dbo].[RegistrationСards]
...
INSERT INTO Patients (LastName, FirstName, Patronymic,Gender,ResidenceAddress)
  ...
  VALUES (2,3,'2021-06-11 00:00:00.000',1),
         (3,2,'2021-01-03 00:00:00.000',5),
         (1,5,'2021-01-10 00:00:00.000',3),
         (5,1,'2021-9-21 00:00:00.000',4),
         (4,4,'2021-12-12 00:00:00.000',2);
GO
